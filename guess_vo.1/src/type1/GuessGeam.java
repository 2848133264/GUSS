...
public class GuessGeam {
	...
	private static String person="小哥哥";//表示用户
	...
	public static void main(String[] args) {
		...
		while (true) {		
			try {
				...
				System.out.println("请正确输入（1 2 3 其中的一个整数）：");
				input.next();
			}
		}
		if (role == 1) {
		...
		while (con.equals("y")) {
			...
			compFist = computerShowFist();// 电脑出拳s
			/* 裁决 */
	...
	private static int personShowFist() {
		  Scanner input1 = new Scanner(System.in);
	  	  ...
	  	  while(true){
				...
				// TODO: handle exception
	  			  System.out.println("请正确输入！（1 剪刀， 2 石头 ，3 布）");
	  			  input1.next();
			}
